...
<p>(2017年12月25日中华人民共和国国务院令第693号公布 自2018年1月1日起施行)</p>
</div>
<details class="custom-container details"><summary>目录</summary>
<Tabs :data='[{"title":"章节"},{"title":"条例"}]'>
<template #tab0="{ title, value, isActive }">
<nav class="table-of-contents"><ul><li><router-link to="#第一章-总则">第一章 总则</router-link></li><li><router-link to="#第二章-计税依据">第二章 计税依据</router-link></li><li><router-link to="#第三章-税收减免">第三章 税收减免</router-link></li><li><router-link to="#第四章-征收管理">第四章 征收管理</router-link></li><li><router-link to="#第五章-附则">第五章 附则</router-link></li></ul></nav>
</template>
...
<li>
<p>第21~26条：</p>
<p><a href="#t21">21</a> <a href="#t22">22</a> <a href="#t23">23</a> <a href="#t24">24</a> <a href="#t25">25</a> <a href="#t26">26</a></p>
</li>
</ul>
</template>
</Tabs>
...
<h2 align="center" id="第二章-计税依据" tabindex="-1"><a class="header-anchor" href="#第二章-计税依据" aria-hidden="true">#</a> 第二章 计税依据</h2>
...
<p><a href="https://flk.npc.gov.cn/detail2.html?ZmY4MDgwODE2ZjNjYmIzYzAxNmY0MTM1NDcxNjFkMWU%3D" target="_blank" rel="noopener noreferrer">https://flk.npc.gov.cn/detail2.html?ZmY4MDgwODE2ZjNjYmIzYzAxNmY0MTM1NDcxNjFkMWU%3D<ExternalLinkIcon/></a></p>
</div>
</div></template>
