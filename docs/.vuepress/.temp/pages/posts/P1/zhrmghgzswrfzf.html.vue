...
<nav class="table-of-contents"><ul><li><router-link to="#第一章-总-则">第一章 总  则</router-link></li><li><router-link to="#第二章-噪声污染防治标准和规划">第二章 噪声污染防治标准和规划</router-link></li><li><router-link to="#第三章-噪声污染防治的监督管理">第三章 噪声污染防治的监督管理</router-link></li><li><router-link to="#第四章-工业噪声污染防治">第四章 工业噪声污染防治</router-link></li><li><router-link to="#第五章-建筑施工噪声污染防治">第五章 建筑施工噪声污染防治</router-link></li><li><router-link to="#第六章-交通运输噪声污染防治">第六章 交通运输噪声污染防治</router-link></li><li><router-link to="#第七章-社会生活噪声污染防治">第七章 社会生活噪声污染防治</router-link></li><li><router-link to="#第八章-法律责任">第八章 法律责任</router-link></li><li><router-link to="#第九章-附-则">第九章 附  则</router-link></li></ul></nav>
</template>
...
<li>
<p>第81条~90条</p>
<p><a href="#t81">81</a> <a href="#t82">82</a> <a href="#t83">83</a> <a href="#t84">84</a> <a href="#t85">85</a> <a href="#t86">86</a> <a href="#t87">87</a> <a href="#t88">88</a> <a href="#t89">89</a> <a href="#t90">90</a></p>
</li>
</ul>
</template>
</Tabs>
...
&emsp;&emsp;新闻媒体应当开展噪声污染防治法律法规和知识的公益宣传，对违反噪声污染防治法律法规的行为进行舆论监督。<br>
&emsp;&emsp;国家鼓励基层群众性自治组织、社会组织、公共场所管理者、业主委员会、物业服务人、志愿者等开展噪声污染防治法律法规和知识的宣传。</p>
<p id="t11">&emsp;&emsp;<b>第十一条</b>&emsp;国家鼓励、支持噪声污染防治科学技术研究开发、成果转化和推广应用，加强噪声污染防治专业技术人才培养，促进噪声污染防治科学技术进步和产业发展。</p>
<p id="t12">&emsp;&emsp;<b>第十二条</b>&emsp;对在噪声污染防治工作中做出显著成绩的单位和个人，按照国家规定给予表彰、奖励。</p>
<h2 align="center" id="第二章-噪声污染防治标准和规划" tabindex="-1"><a class="header-anchor" href="#第二章-噪声污染防治标准和规划" aria-hidden="true">#</a> 第二章 噪声污染防治标准和规划</h2>
<p id="t13">&emsp;&emsp;<b>第十三条</b>&emsp;国家推进噪声污染防治标准体系建设。<br>
&emsp;&emsp;国务院生态环境主管部门和国务院其他有关部门，在各自职责范围内，制定和完善噪声污染防治相关标准，加强标准之间的衔接协调。</p>
<p id="t14">&emsp;&emsp;<b>第十四条</b>&emsp;国务院生态环境主管部门制定国家声环境质量标准。<br>
&emsp;&emsp;县级以上地方人民政府根据国家声环境质量标准和国土空间规划以及用地现状，划定本行政区域各类声环境质量标准的适用区域；将以用于居住、科学研究、医疗卫生、文化教育、机关团体办公、社会福利等的建筑物为主的区域，划定为噪声敏感建筑物集中区域，加强噪声污染防治。<br>
&emsp;&emsp;声环境质量标准适用区域范围和噪声敏感建筑物集中区域范围应当向社会公布。</p>
<p id="t15">&emsp;&emsp;<b>第十五条</b>&emsp;国务院生态环境主管部门根据国家声环境质量标准和国家经济、技术条件，制定国家噪声排放标准以及相关的环境振动控制标准。<br>
&emsp;&emsp;省、自治区、直辖市人民政府对尚未制定国家噪声排放标准的，可以制定地方噪声排放标准；对已经制定国家噪声排放标准的，可以制定严于国家噪声排放标准的地方噪声排放标准。地方噪声排放标准应当报国务院生态环境主管部门备案。</p>
<p id="t16">&emsp;&emsp;<b>第十六条</b>&emsp;国务院标准化主管部门会同国务院发展改革、生态环境、工业和信息化、住房和城乡建设、交通运输、铁路监督管理、民用航空、海事等部门，对可能产生噪声污染的工业设备、施工机械、机动车、铁路机车车辆、城市轨道交通车辆、民用航空器、机动船舶、电气电子产品、建筑附属设备等产品，根据声环境保护的要求和国家经济、技术条件，在其技术规范或者产品质量标准中规定噪声限值。<br>
&emsp;&emsp;前款规定的产品使用时产生噪声的限值，应当在有关技术文件中注明。禁止生产、进口或者销售不符合噪声限值的产品。<br>
&emsp;&emsp;县级以上人民政府市场监督管理等部门对生产、销售的有噪声限值的产品进行监督抽查，对电梯等特种设备使用时发出的噪声进行监督抽测，生态环境主管部门予以配合。</p>
<p id="t17">&emsp;&emsp;<b>第十七条</b>&emsp;声环境质量标准、噪声排放标准和其他噪声污染防治相关标准应当定期评估，并根据评估结果适时修订。</p>
<p id="t18">&emsp;&emsp;<b>第十八条</b>&emsp;各级人民政府及其有关部门制定、修改国土空间规划和相关规划，应当依法进行环境影响评价，充分考虑城乡区域开发、改造和建设项目产生的噪声对周围生活环境的影响，统筹规划，合理安排土地用途和建设布局，防止、减轻噪声污染。有关环境影响篇章、说明或者报告书中应当包括噪声污染防治内容。</p>
<p id="t19">&emsp;&emsp;<b>第十九条</b>&emsp;确定建设布局，应当根据国家声环境质量标准和民用建筑隔声设计相关标准，合理划定建筑物与交通干线等的防噪声距离，并提出相应的规划设计要求。</p>
...
<h2 align="center" id="第三章-噪声污染防治的监督管理" tabindex="-1"><a class="header-anchor" href="#第三章-噪声污染防治的监督管理" aria-hidden="true">#</a> 第三章 噪声污染防治的监督管理</h2>
...
<h2 align="center" id="第四章-工业噪声污染防治" tabindex="-1"><a class="header-anchor" href="#第四章-工业噪声污染防治" aria-hidden="true">#</a> 第四章 工业噪声污染防治</h2>
...
<h2 align="center" id="第五章-建筑施工噪声污染防治" tabindex="-1"><a class="header-anchor" href="#第五章-建筑施工噪声污染防治" aria-hidden="true">#</a> 第五章 建筑施工噪声污染防治</h2>
<p id="t39">&emsp;&emsp;<b>第三十九条</b>&emsp;本法所称建筑施工噪声，是指在建筑施工过程中产生的干扰周围生活环境的声音。</p>
<p id="t40">&emsp;&emsp;<b>第四十条</b>&emsp;建设单位应当按照规定将噪声污染防治费用列入工程造价，在施工合同中明确施工单位的噪声污染防治责任。<br>
&emsp;&emsp;施工单位应当按照规定制定噪声污染防治实施方案，采取有效措施，减少振动、降低噪声。建设单位应当监督施工单位落实噪声污染防治实施方案。</p>
<p id="t41">&emsp;&emsp;<b>第四十一条</b>&emsp;在噪声敏感建筑物集中区域施工作业，应当优先使用低噪声施工工艺和设备。<br>
&emsp;&emsp;国务院工业和信息化主管部门会同国务院生态环境、住房和城乡建设、市场监督管理等部门，公布低噪声施工设备指导名录并适时更新。</p>
<p id="t42">&emsp;&emsp;<b>第四十二条</b>&emsp;在噪声敏感建筑物集中区域施工作业，建设单位应当按照国家规定，设置噪声自动监测系统，与监督管理部门联网，保存原始监测记录，对监测数据的真实性和准确性负责。</p>
<p id="t43">&emsp;&emsp;<b>第四十三条</b>&emsp;在噪声敏感建筑物集中区域，禁止夜间进行产生噪声的建筑施工作业，但抢修、抢险施工作业，因生产工艺要求或者其他特殊需要必须连续施工作业的除外。<br>
&emsp;&emsp;因特殊需要必须连续施工作业的，应当取得地方人民政府住房和城乡建设、生态环境主管部门或者地方人民政府指定的部门的证明，并在施工现场显著位置公示或者以其他方式公告附近居民。</p>
<h2 align="center" id="第六章-交通运输噪声污染防治" tabindex="-1"><a class="header-anchor" href="#第六章-交通运输噪声污染防治" aria-hidden="true">#</a> 第六章 交通运输噪声污染防治</h2>
<p id="t44">&emsp;&emsp;<b>第四十四条</b>&emsp;本法所称交通运输噪声，是指机动车、铁路机车车辆、城市轨道交通车辆、机动船舶、航空器等交通运输工具在运行时产生的干扰周围生活环境的声音。</p>
<p id="t45">&emsp;&emsp;<b>第四十五条</b>&emsp;各级人民政府及其有关部门制定、修改国土空间规划和交通运输等相关规划，应当综合考虑公路、城市道路、铁路、城市轨道交通线路、水路、港口和民用机场及其起降航线对周围声环境的影响。<br>
&emsp;&emsp;新建公路、铁路线路选线设计，应当尽量避开噪声敏感建筑物集中区域。<br>
&emsp;&emsp;新建民用机场选址与噪声敏感建筑物集中区域的距离应当符合标准要求。</p>
<p id="t46">&emsp;&emsp;<b>第四十六条</b>&emsp;制定交通基础设施工程技术规范，应当明确噪声污染防治要求。<br>
&emsp;&emsp;新建、改建、扩建经过噪声敏感建筑物集中区域的高速公路、城市高架、铁路和城市轨道交通线路等的，建设单位应当在可能造成噪声污染的重点路段设置声屏障或者采取其他减少振动、降低噪声的措施，符合有关交通基础设施工程技术规范以及标准要求。<br>
&emsp;&emsp;建设单位违反前款规定的，由县级以上人民政府指定的部门责令制定、实施治理方案。</p>
<p id="t47">&emsp;&emsp;<b>第四十七条</b>&emsp;机动车的消声器和喇叭应当符合国家规定。禁止驾驶拆除或者损坏消声器、加装排气管等擅自改装的机动车以轰鸣、疾驶等方式造成噪声污染。<br>
&emsp;&emsp;使用机动车音响器材，应当控制音量，防止噪声污染。<br>
&emsp;&emsp;机动车应当加强维修和保养，保持性能良好，防止噪声污染。</p>
<p id="t48">&emsp;&emsp;<b>第四十八条</b>&emsp;机动车、铁路机车车辆、城市轨道交通车辆、机动船舶等交通运输工具运行时，应当按照规定使用喇叭等声响装置。<br>
&emsp;&emsp;警车、消防救援车、工程救险车、救护车等机动车安装、使用警报器，应当符合国务院公安等部门的规定；非执行紧急任务，不得使用警报器。</p>
<p id="t49">&emsp;&emsp;<b>第四十九条</b>&emsp;地方人民政府生态环境主管部门会同公安机关根据声环境保护的需要，可以划定禁止机动车行驶和使用喇叭等声响装置的路段和时间，向社会公告，并由公安机关交通管理部门依法设置相关标志、标线。</p>
<p id="t50">&emsp;&emsp;<b>第五十条</b>&emsp;在车站、铁路站场、港口等地指挥作业时使用广播喇叭的，应当控制音量，减轻噪声污染。</p>
<p id="t51">&emsp;&emsp;<b>第五十一条</b>&emsp;公路养护管理单位、城市道路养护维修单位应当加强对公路、城市道路的维护和保养，保持减少振动、降低噪声设施正常运行。<br>
&emsp;&emsp;城市轨道交通运营单位、铁路运输企业应当加强对城市轨道交通线路和城市轨道交通车辆、铁路线路和铁路机车车辆的维护和保养，保持减少振动、降低噪声设施正常运行，并按照国家规定进行监测，保存原始监测记录，对监测数据的真实性和准确性负责。</p>
<p id="t52">&emsp;&emsp;<b>第五十二条</b>&emsp;民用机场所在地人民政府，应当根据环境影响评价以及监测结果确定的民用航空器噪声对机场周围生活环境产生影响的范围和程度，划定噪声敏感建筑物禁止建设区域和限制建设区域，并实施控制。<br>
...
<h2 align="center" id="第七章-社会生活噪声污染防治" tabindex="-1"><a class="header-anchor" href="#第七章-社会生活噪声污染防治" aria-hidden="true">#</a> 第七章 社会生活噪声污染防治</h2>
...
<p id="t71">&emsp;&emsp;<b>第七十一条</b>&emsp;违反本法规定，拒绝、阻挠监督检查，或者在接受监督检查时弄虚作假的，由生态环境主管部门或者其他负有噪声污染防治监督管理职责的部门责令改正，处二万元以上二十万元以下的罚款。</p>
<p id="t72">&emsp;&emsp;<b>第七十二条</b>&emsp;违反本法规定，生产、进口、销售超过噪声限值的产品的，由县级以上人民政府市场监督管理部门、海关按照职责责令改正，没收违法所得，并处货值金额一倍以上三倍以下的罚款；情节严重的，报经有批准权的人民政府批准，责令停业、关闭。<br>
&emsp;&emsp;违反本法规定，生产、进口、销售、使用淘汰的设备，或者采用淘汰的工艺的，由县级以上人民政府指定的部门责令改正，没收违法所得，并处货值金额一倍以上三倍以下的罚款；情节严重的，报经有批准权的人民政府批准，责令停业、关闭。</p>
<p id="t73">&emsp;&emsp;<b>第七十三条</b>&emsp;违反本法规定，建设单位建设噪声敏感建筑物不符合民用建筑隔声设计相关标准要求的，由县级以上地方人民政府住房和城乡建设主管部门责令改正，处建设工程合同价款百分之二以上百分之四以下的罚款。<br>
&emsp;&emsp;违反本法规定，建设单位在噪声敏感建筑物禁止建设区域新建与航空无关的噪声敏感建筑物的，由地方人民政府指定的部门责令停止违法行为，处建设工程合同价款百分之二以上百分之十以下的罚款，并报经有批准权的人民政府批准，责令拆除。</p>
<p id="t74">&emsp;&emsp;<b>第七十四条</b>&emsp;违反本法规定，在噪声敏感建筑物集中区域新建排放噪声的工业企业的，由生态环境主管部门责令停止违法行为，处十万元以上五十万元以下的罚款，并报经有批准权的人民政府批准，责令关闭。<br>
&emsp;&emsp;违反本法规定，在噪声敏感建筑物集中区域改建、扩建工业企业，未采取有效措施防止工业噪声污染的，由生态环境主管部门责令改正，处十万元以上五十万元以下的罚款；拒不改正的，报经有批准权的人民政府批准，责令关闭。</p>
<p id="t75">&emsp;&emsp;<b>第七十五条</b>&emsp;违反本法规定，无排污许可证或者超过噪声排放标准排放工业噪声的，由生态环境主管部门责令改正或者限制生产、停产整治，并处二万元以上二十万元以下的罚款；情节严重的，报经有批准权的人民政府批准，责令停业、关闭。</p>
<p id="t76">&emsp;&emsp;<b>第七十六条</b>&emsp;违反本法规定，有下列行为之一，由生态环境主管部门责令改正，处二万元以上二十万元以下的罚款；拒不改正的，责令限制生产、停产整治：<br>
&emsp;&emsp;（一）实行排污许可管理的单位未按照规定对工业噪声开展自行监测，未保存原始监测记录，或者未向社会公开监测结果的；<br>
&emsp;&emsp;（二）噪声重点排污单位未按照国家规定安装、使用、维护噪声自动监测设备，或者未与生态环境主管部门的监控设备联网的。</p>
<p id="t77">&emsp;&emsp;<b>第七十七条</b>&emsp;违反本法规定，建设单位、施工单位有下列行为之一，由工程所在地人民政府指定的部门责令改正，处一万元以上十万元以下的罚款；拒不改正的，可以责令暂停施工：<br>
&emsp;&emsp;（一）超过噪声排放标准排放建筑施工噪声的；<br>
&emsp;&emsp;（二）未按照规定取得证明，在噪声敏感建筑物集中区域夜间进行产生噪声的建筑施工作业的。</p>
<p id="t78">&emsp;&emsp;<b>第七十八条</b>&emsp;违反本法规定，有下列行为之一，由工程所在地人民政府指定的部门责令改正，处五千元以上五万元以下的罚款；拒不改正的，处五万元以上二十万元以下的罚款：<br>
&emsp;&emsp;（一）建设单位未按照规定将噪声污染防治费用列入工程造价的；<br>
&emsp;&emsp;（二）施工单位未按照规定制定噪声污染防治实施方案，或者未采取有效措施减少振动、降低噪声的；<br>
&emsp;&emsp;（三）在噪声敏感建筑物集中区域施工作业的建设单位未按照国家规定设置噪声自动监测系统，未与监督管理部门联网，或者未保存原始监测记录的；<br>
&emsp;&emsp;（四）因特殊需要必须连续施工作业，建设单位未按照规定公告附近居民的。</p>
<p id="t79">&emsp;&emsp;<b>第七十九条</b>&emsp;违反本法规定，驾驶拆除或者损坏消声器、加装排气管等擅自改装的机动车轰鸣、疾驶，机动车运行时未按照规定使用声响装置，或者违反禁止机动车行驶和使用声响装置的路段和时间规定的，由县级以上地方人民政府公安机关交通管理部门依照有关道路交通安全的法律法规处罚。<br>
...
<p><a href="https://flk.npc.gov.cn/detail2.html?ZmY4MDgxODE3ZGVhOWMxODAxN2RlYjcwZGRjNzAxMzE%3D" target="_blank" rel="noopener noreferrer">https://flk.npc.gov.cn/detail2.html?ZmY4MDgxODE3ZGVhOWMxODAxN2RlYjcwZGRjNzAxMzE%3D<ExternalLinkIcon/></a></p>
</div>
</div></template>
