...
<p>（2002年10月28日第九届全国人民代表大会常务委员会第三十次会议通过 根据2016年7月2日第十二届全国人民代表大会常务委员会第二十一次会议《关于修改&lt;中华人民共和国节约能源法&gt;等六部法律的决定》第一次修正 根据2018年12月29日第十三届全国人民代表大会常务委员会第七次会议《关于修改&lt;中华人民共和国劳动法&gt;等七部法律的决定》第二次修正）</p>
</div>
<details class="custom-container details"><summary>目录</summary>
<Tabs :data='[{"title":"章节"},{"title":"条例"}]'>
<template #tab0="{ title, value, isActive }">
<nav class="table-of-contents"><ul><li><router-link to="#第一章-总则">第一章 总则</router-link></li><li><router-link to="#第二章-规划的环境影响评价">第二章 规划的环境影响评价</router-link></li><li><router-link to="#第三章-建设项目的环境影响评价">第三章 建设项目的环境影响评价</router-link></li><li><router-link to="#第四章-法律责任">第四章 法律责任</router-link></li><li><router-link to="#第五章-附则">第五章 附则</router-link></li></ul></nav>
</template>
