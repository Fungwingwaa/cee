...
<p>（2011年6月30日第十一届全国人民代表大会常务委员会第二十一次会议通过）</p>
</div>
<details class="custom-container details"><summary>目录</summary>
<Tabs :data='[{"title":"章节"},{"title":"条例"}]'>
<template #tab0="{ title, value, isActive }">
<nav class="table-of-contents"><ul><li><router-link to="#第一章-总则">第一章 总则</router-link></li><li><router-link to="#第二章-行政强制的种类和设定">第二章 行政强制的种类和设定</router-link></li><li><router-link to="#第三章-行政强制措施实施程序">第三章 行政强制措施实施程序</router-link><ul><li><router-link to="#第一节-一般规定">第一节 一般规定</router-link></li><li><router-link to="#第二节-查封、扣押">第二节 查封、扣押</router-link></li><li><router-link to="#第三节-冻结">第三节 冻结</router-link></li></ul></li><li><router-link to="#第四章-行政机关强制执行程序">第四章 行政机关强制执行程序</router-link><ul><li><router-link to="#第一节-一般规定-1">第一节 一般规定</router-link></li><li><router-link to="#第二节-金钱给付义务的执行">第二节 金钱给付义务的执行</router-link></li><li><router-link to="#第三节-代履行">第三节 代履行</router-link></li></ul></li><li><router-link to="#第五章-申请人民法院强制执行">第五章 申请人民法院强制执行</router-link></li><li><router-link to="#第六章-法律责任">第六章 法律责任</router-link></li><li><router-link to="#第七章-附则">第七章 附则</router-link></li></ul></nav>
</template>
...
<h3 align="center" id="第二节-金钱给付义务的执行" tabindex="-1"><a class="header-anchor" href="#第二节-金钱给付义务的执行" aria-hidden="true">#</a> 第二节 金钱给付义务的执行</h3>
