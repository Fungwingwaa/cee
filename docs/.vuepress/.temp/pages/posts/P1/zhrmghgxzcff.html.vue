...
<p>（1996年3月17日第八届全国人民代表大会第四次会议通过 根据2009年8月27日第十一届全国人民代表大会常务委员会第十次会议《关于修改部分法律的决定》第一次修正 根据2017年9月1日第十二届全国人民代表大会常务委员会第二十九次会议《关于修改&lt;中华人民共和国法官法&gt;等八部法律的决定》第二次修正 2021年1月22日第十三届全国人民代表大会常务委员会第二十五次会议修订）</p>
</div>
<details class="custom-container details"><summary>目录</summary>
<Tabs :data='[{"title":"章节"},{"title":"条例"}]'>
<template #tab0="{ title, value, isActive }">
<nav class="table-of-contents"><ul><li><router-link to="#第一章-总则">第一章 总则</router-link></li><li><router-link to="#第二章-行政处罚的种类和设定">第二章 行政处罚的种类和设定</router-link></li><li><router-link to="#第三章-行政处罚的实施机关">第三章 行政处罚的实施机关</router-link></li><li><router-link to="#第四章-行政处罚的管辖和适用">第四章 行政处罚的管辖和适用</router-link></li><li><router-link to="#第五章-行政处罚的决定">第五章 行政处罚的决定</router-link><ul><li><router-link to="#第一节-一般规定">第一节 一般规定</router-link></li><li><router-link to="#第二节-简易程序">第二节 简易程序</router-link></li><li><router-link to="#第三节-普通程序">第三节 普通程序</router-link></li><li><router-link to="#第四节-听证程序">第四节 听证程序</router-link></li></ul></li><li><router-link to="#第六章-行政处罚的执行">第六章 行政处罚的执行</router-link></li><li><router-link to="#第七章-法律责任">第七章 法律责任</router-link></li><li><router-link to="#第八章-附则">第八章 附则</router-link></li></ul></nav>
</template>
...
<li>
<p>第81条~86条</p>
<p><a href="#t81">81</a> <a href="#t82">82</a> <a href="#t83">83</a> <a href="#t84">84</a> <a href="#t85">85</a> <a href="#t86">86</a></p>
</li>
</ul>
</template>
</Tabs>
...
<h2 align="center" id="第二章-行政处罚的种类和设定" tabindex="-1"><a class="header-anchor" href="#第二章-行政处罚的种类和设定" aria-hidden="true">#</a> 第二章 行政处罚的种类和设定</h2>
...
<h2 align="center" id="第三章-行政处罚的实施机关" tabindex="-1"><a class="header-anchor" href="#第三章-行政处罚的实施机关" aria-hidden="true">#</a> 第三章 行政处罚的实施机关</h2>
<p id="t17">&emsp;&emsp;<b>第十七条</b>&emsp;行政处罚由具有行政处罚权的行政机关在法定职权范围内实施。</p>
<p id="t18">&emsp;&emsp;<b>第十八条</b>&emsp;国家在城市管理、市场监管、生态环境、文化市场、交通运输、应急管理、农业等领域推行建立综合行政执法制度，相对集中行政处罚权。<br>
&emsp;&emsp;国务院或者省、自治区、直辖市人民政府可以决定一个行政机关行使有关行政机关的行政处罚权。<br>
&emsp;&emsp;限制人身自由的行政处罚权只能由公安机关和法律规定的其他机关行使。</p>
<p id="t19">&emsp;&emsp;<b>第十九条</b>&emsp;法律、法规授权的具有管理公共事务职能的组织可以在法定授权范围内实施行政处罚。</p>
<p id="t20">&emsp;&emsp;<b>第二十条</b>&emsp;行政机关依照法律、法规、规章的规定，可以在其法定权限内书面委托符合本法第二十一条规定条件的组织实施行政处罚。行政机关不得委托其他组织或者个人实施行政处罚。<br>
&emsp;&emsp;委托书应当载明委托的具体事项、权限、期限等内容。委托行政机关和受委托组织应当将委托书向社会公布。<br>
&emsp;&emsp;委托行政机关对受委托组织实施行政处罚的行为应当负责监督，并对该行为的后果承担法律责任。<br>
&emsp;&emsp;受委托组织在委托范围内，以委托行政机关名义实施行政处罚；不得再委托其他组织或者个人实施行政处罚。</p>
<p id="t21">&emsp;&emsp;<b>第二十一条</b>&emsp;受委托组织必须符合以下条件：<br>
&emsp;&emsp;（一）依法成立并具有管理公共事务职能；<br>
&emsp;&emsp;（二）有熟悉有关法律、法规、规章和业务并取得行政执法资格的工作人员；<br>
&emsp;&emsp;（三）需要进行技术检查或者技术鉴定的，应当有条件组织进行相应的技术检查或者技术鉴定。</p>
<h2 align="center" id="第四章-行政处罚的管辖和适用" tabindex="-1"><a class="header-anchor" href="#第四章-行政处罚的管辖和适用" aria-hidden="true">#</a> 第四章 行政处罚的管辖和适用</h2>
<p id="t22">&emsp;&emsp;<b>第二十二条</b>&emsp;行政处罚由违法行为发生地的行政机关管辖。法律、行政法规、部门规章另有规定的，从其规定。</p>
<p id="t23">&emsp;&emsp;<b>第二十三条</b>&emsp;行政处罚由县级以上地方人民政府具有行政处罚权的行政机关管辖。法律、行政法规另有规定的，从其规定。</p>
<p id="t24">&emsp;&emsp;<b>第二十四条</b>&emsp;省、自治区、直辖市根据当地实际情况，可以决定将基层管理迫切需要的县级人民政府部门的行政处罚权交由能够有效承接的乡镇人民政府、街道办事处行使，并定期组织评估。决定应当公布。<br>
&emsp;&emsp;承接行政处罚权的乡镇人民政府、街道办事处应当加强执法能力建设，按照规定范围、依照法定程序实施行政处罚。<br>
&emsp;&emsp;有关地方人民政府及其部门应当加强组织协调、业务指导、执法监督，建立健全行政处罚协调配合机制，完善评议、考核制度。</p>
<p id="t25">&emsp;&emsp;<b>第二十五条</b>&emsp;两个以上行政机关都有管辖权的，由最先立案的行政机关管辖。<br>
&emsp;&emsp;对管辖发生争议的，应当协商解决，协商不成的，报请共同的上一级行政机关指定管辖；也可以直接由共同的上一级行政机关指定管辖。</p>
<p id="t26">&emsp;&emsp;<b>第二十六条</b>&emsp;行政机关因实施行政处罚的需要，可以向有关机关提出协助请求。协助事项属于被请求机关职权范围内的，应当依法予以协助。</p>
<p id="t27">&emsp;&emsp;<b>第二十七条</b>&emsp;违法行为涉嫌犯罪的，行政机关应当及时将案件移送司法机关，依法追究刑事责任。对依法不需要追究刑事责任或者免予刑事处罚，但应当给予行政处罚的，司法机关应当及时将案件移送有关行政机关。<br>
&emsp;&emsp;行政处罚实施机关与司法机关之间应当加强协调配合，建立健全案件移送制度，加强证据材料移交、接收衔接，完善案件处理信息通报机制。</p>
<p id="t28">&emsp;&emsp;<b>第二十八条</b>&emsp;行政机关实施行政处罚时，应当责令当事人改正或者限期改正违法行为。<br>
&emsp;&emsp;当事人有违法所得，除依法应当退赔的外，应当予以没收。违法所得是指实施违法行为所取得的款项。法律、行政法规、部门规章对违法所得的计算另有规定的，从其规定。</p>
<p id="t29">&emsp;&emsp;<b>第二十九条</b>&emsp;对当事人的同一个违法行为，不得给予两次以上罚款的行政处罚。同一个违法行为违反多个法律规范应当给予罚款处罚的，按照罚款数额高的规定处罚。</p>
<p id="t30">&emsp;&emsp;<b>第三十条</b>&emsp;不满十四周岁的未成年人有违法行为的，不予行政处罚，责令监护人加以管教；已满十四周岁不满十八周岁的未成年人有违法行为的，应当从轻或者减轻行政处罚。</p>
<p id="t31">&emsp;&emsp;<b>第三十一条</b>&emsp;精神病人、智力残疾人在不能辨认或者不能控制自己行为时有违法行为的，不予行政处罚，但应当责令其监护人严加看管和治疗。间歇性精神病人在精神正常时有违法行为的，应当给予行政处罚。尚未完全丧失辨认或者控制自己行为能力的精神病人、智力残疾人有违法行为的，可以从轻或者减轻行政处罚。</p>
<p id="t32">&emsp;&emsp;<b>第三十二条</b>&emsp;当事人有下列情形之一，应当从轻或者减轻行政处罚：<br>
&emsp;&emsp;（一）主动消除或者减轻违法行为危害后果的；<br>
&emsp;&emsp;（二）受他人胁迫或者诱骗实施违法行为的；<br>
&emsp;&emsp;（三）主动供述行政机关尚未掌握的违法行为的；<br>
&emsp;&emsp;（四）配合行政机关查处违法行为有立功表现的；<br>
&emsp;&emsp;（五）法律、法规、规章规定其他应当从轻或者减轻行政处罚的。</p>
<p id="t33">&emsp;&emsp;<b>第三十三条</b>&emsp;违法行为轻微并及时改正，没有造成危害后果的，不予行政处罚。初次违法且危害后果轻微并及时改正的，可以不予行政处罚。<br>
&emsp;&emsp;当事人有证据足以证明没有主观过错的，不予行政处罚。法律、行政法规另有规定的，从其规定。<br>
&emsp;&emsp;对当事人的违法行为依法不予行政处罚的，行政机关应当对当事人进行教育。</p>
<p id="t34">&emsp;&emsp;<b>第三十四条</b>&emsp;行政机关可以依法制定行政处罚裁量基准，规范行使行政处罚裁量权。行政处罚裁量基准应当向社会公布。</p>
<p id="t35">&emsp;&emsp;<b>第三十五条</b>&emsp;违法行为构成犯罪，人民法院判处拘役或者有期徒刑时，行政机关已经给予当事人行政拘留的，应当依法折抵相应刑期。<br>
&emsp;&emsp;违法行为构成犯罪，人民法院判处罚金时，行政机关已经给予当事人罚款的，应当折抵相应罚金；行政机关尚未给予当事人罚款的，不再给予罚款。</p>
<p id="t36">&emsp;&emsp;<b>第三十六条</b>&emsp;违法行为在二年内未被发现的，不再给予行政处罚；涉及公民生命健康安全、金融安全且有危害后果的，上述期限延长至五年。法律另有规定的除外。<br>
&emsp;&emsp;前款规定的期限，从违法行为发生之日起计算；违法行为有连续或者继续状态的，从行为终了之日起计算。</p>
<p id="t37">&emsp;&emsp;<b>第三十七条</b>&emsp;实施行政处罚，适用违法行为发生时的法律、法规、规章的规定。但是，作出行政处罚决定时，法律、法规、规章已被修改或者废止，且新的规定处罚较轻或者不认为是违法的，适用新的规定。</p>
<p id="t38">&emsp;&emsp;<b>第三十八条</b>&emsp;行政处罚没有依据或者实施主体不具有行政主体资格的，行政处罚无效。<br>
&emsp;&emsp;违反法定程序构成重大且明显违法的，行政处罚无效。</p>
<h2 align="center" id="第五章-行政处罚的决定" tabindex="-1"><a class="header-anchor" href="#第五章-行政处罚的决定" aria-hidden="true">#</a> 第五章 行政处罚的决定</h2>
...
<h3 align="center" id="第二节-简易程序" tabindex="-1"><a class="header-anchor" href="#第二节-简易程序" aria-hidden="true">#</a> 第二节 简易程序</h3>
...
<h3 align="center" id="第三节-普通程序" tabindex="-1"><a class="header-anchor" href="#第三节-普通程序" aria-hidden="true">#</a> 第三节 普通程序</h3>
...
<h3 align="center" id="第四节-听证程序" tabindex="-1"><a class="header-anchor" href="#第四节-听证程序" aria-hidden="true">#</a> 第四节 听证程序</h3>
...
<h2 align="center" id="第六章-行政处罚的执行" tabindex="-1"><a class="header-anchor" href="#第六章-行政处罚的执行" aria-hidden="true">#</a> 第六章 行政处罚的执行</h2>
...
<p><a href="https://flk.npc.gov.cn/detail2.html?ZmY4MDgwODE3NzAzYWRkMjAxNzczNzNkZjZhNDNlMzM%3D" target="_blank" rel="noopener noreferrer">https://flk.npc.gov.cn/detail2.html?ZmY4MDgwODE3NzAzYWRkMjAxNzczNzNkZjZhNDNlMzM%3D<ExternalLinkIcon/></a></p>
</div>
</div></template>
