...
<p>（2018年8月31日第十三届全国人民代表大会常务委员会第五次会议通过）</p>
</div>
<details class="custom-container details"><summary>目录</summary>
<Tabs :data='[{"title":"章节"},{"title":"条例"}]'>
<template #tab0="{ title, value, isActive }">
<nav class="table-of-contents"><ul><li><router-link to="#第一章-总则">第一章 总则</router-link></li><li><router-link to="#第二章-规划、标准、普查和监测">第二章 规划、标准、普查和监测</router-link></li><li><router-link to="#第三章-预防和保护">第三章 预防和保护</router-link></li><li><router-link to="#第四章-风险管控和修复">第四章 风险管控和修复</router-link><ul><li><router-link to="#第一节-一般规定">第一节 一般规定</router-link></li><li><router-link to="#第二节-农用地">第二节 农用地</router-link></li><li><router-link to="#第三节-建设用地">第三节 建设用地</router-link></li></ul></li><li><router-link to="#第五章-保障和监督">第五章 保障和监督</router-link></li><li><router-link to="#第六章-法律责任">第六章 法律责任</router-link></li><li><router-link to="#第七章-附则">第七章 附则</router-link></li></ul></nav>
</template>
...
<li>
<p>第81条~99条</p>
<p><a href="#t81">81</a> <a href="#t82">82</a> <a href="#t83">83</a> <a href="#t84">84</a> <a href="#t85">85</a> <a href="#t86">86</a> <a href="#t87">87</a> <a href="#t88">88</a> <a href="#t89">89</a> <a href="#t90">90</a> <a href="#t91">91</a> <a href="#t92">92</a> <a href="#t93">93</a> <a href="#t94">94</a> <a href="#t95">95</a> <a href="#t96">96</a> <a href="#t97">97</a> <a href="#t98">98</a> <a href="#t99">99</a></p>
</li>
</ul>
</template>
</Tabs>
...
<h2 align="center" id="第二章-规划、标准、普查和监测" tabindex="-1"><a class="header-anchor" href="#第二章-规划、标准、普查和监测" aria-hidden="true">#</a> 第二章 规划、标准、普查和监测</h2>
...
&emsp;&emsp;（三）用于或者曾用于规模化养殖，固体废物堆放、填埋的；<br>
&emsp;&emsp;（四）曾作为工矿用地或者发生过重大、特大污染事故的；<br>
&emsp;&emsp;（五）有毒有害物质生产、贮存、利用、处置设施周边的；<br>
&emsp;&emsp;（六）国务院农业农村、林业草原、生态环境、自然资源主管部门规定的其他情形。</p>
<p id="t17">&emsp;&emsp;<b>第十七条</b>&emsp;地方人民政府生态环境主管部门应当会同自然资源主管部门对下列建设用地地块进行重点监测：<br>
&emsp;&emsp;（一）曾用于生产、使用、贮存、回收、处置有毒有害物质的；<br>
&emsp;&emsp;（二）曾用于固体废物堆放、填埋的；<br>
&emsp;&emsp;（三）曾发生过重大、特大污染事故的；<br>
&emsp;&emsp;（四）国务院生态环境、自然资源主管部门规定的其他情形。</p>
<h2 align="center" id="第三章-预防和保护" tabindex="-1"><a class="header-anchor" href="#第三章-预防和保护" aria-hidden="true">#</a> 第三章 预防和保护</h2>
<p id="t18">&emsp;&emsp;<b>第十八条</b>&emsp;各类涉及土地利用的规划和可能造成土壤污染的建设项目，应当依法进行环境影响评价。环境影响评价文件应当包括对土壤可能造成的不良影响及应当采取的相应预防措施等内容。</p>
<p id="t19">&emsp;&emsp;<b>第十九条</b>&emsp;生产、使用、贮存、运输、回收、处置、排放有毒有害物质的单位和个人，应当采取有效措施，防止有毒有害物质渗漏、流失、扬散，避免土壤受到污染。</p>
<p id="t20">&emsp;&emsp;<b>第二十条</b>&emsp;国务院生态环境主管部门应当会同国务院卫生健康等主管部门，根据对公众健康、生态环境的危害和影响程度，对土壤中有毒有害物质进行筛查评估，公布重点控制的土壤有毒有害物质名录，并适时更新。</p>
<p id="t21">&emsp;&emsp;<b>第二十一条</b>&emsp;设区的市级以上地方人民政府生态环境主管部门应当按照国务院生态环境主管部门的规定，根据有毒有害物质排放等情况，制定本行政区域土壤污染重点监管单位名录，向社会公开并适时更新。<br>
&emsp;&emsp;土壤污染重点监管单位应当履行下列义务：<br>
&emsp;&emsp;（一）严格控制有毒有害物质排放，并按年度向生态环境主管部门报告排放情况；<br>
&emsp;&emsp;（二）建立土壤污染隐患排查制度，保证持续有效防止有毒有害物质渗漏、流失、扬散；<br>
&emsp;&emsp;（三）制定、实施自行监测方案，并将监测数据报生态环境主管部门。<br>
&emsp;&emsp;前款规定的义务应当在排污许可证中载明。<br>
&emsp;&emsp;土壤污染重点监管单位应当对监测数据的真实性和准确性负责。生态环境主管部门发现土壤污染重点监管单位监测数据异常，应当及时进行调查。<br>
&emsp;&emsp;设区的市级以上地方人民政府生态环境主管部门应当定期对土壤污染重点监管单位周边土壤进行监测。</p>
<p id="t22">&emsp;&emsp;<b>第二十二条</b>&emsp;企业事业单位拆除设施、设备或者建筑物、构筑物的，应当采取相应的土壤污染防治措施。<br>
&emsp;&emsp;土壤污染重点监管单位拆除设施、设备或者建筑物、构筑物的，应当制定包括应急措施在内的土壤污染防治工作方案，报地方人民政府生态环境、工业和信息化主管部门备案并实施。</p>
<p id="t23">&emsp;&emsp;<b>第二十三条</b>&emsp;各级人民政府生态环境、自然资源主管部门应当依法加强对矿产资源开发区域土壤污染防治的监督管理，按照相关标准和总量控制的要求，严格控制可能造成土壤污染的重点污染物排放。<br>
&emsp;&emsp;尾矿库运营、管理单位应当按照规定，加强尾矿库的安全管理，采取措施防止土壤污染。危库、险库、病库以及其他需要重点监管的尾矿库的运营、管理单位应当按照规定，进行土壤污染状况监测和定期评估。</p>
<p id="t24">&emsp;&emsp;<b>第二十四条</b>&emsp;国家鼓励在建筑、通信、电力、交通、水利等领域的信息、网络、防雷、接地等建设工程中采用新技术、新材料，防止土壤污染。<br>
&emsp;&emsp;禁止在土壤中使用重金属含量超标的降阻产品。</p>
...
<h2 align="center" id="第四章-风险管控和修复" tabindex="-1"><a class="header-anchor" href="#第四章-风险管控和修复" aria-hidden="true">#</a> 第四章 风险管控和修复</h2>
<h3 align="center" id="第一节-一般规定" tabindex="-1"><a class="header-anchor" href="#第一节-一般规定" aria-hidden="true">#</a> 第一节 一般规定</h3>
...
<h3 align="center" id="第二节-农用地" tabindex="-1"><a class="header-anchor" href="#第二节-农用地" aria-hidden="true">#</a> 第二节 农用地</h3>
...
<h3 align="center" id="第三节-建设用地" tabindex="-1"><a class="header-anchor" href="#第三节-建设用地" aria-hidden="true">#</a> 第三节 建设用地</h3>
<p id="t58">&emsp;&emsp;<b>第五十八条</b>&emsp;国家实行建设用地土壤污染风险管控和修复名录制度。<br>
&emsp;&emsp;建设用地土壤污染风险管控和修复名录由省级人民政府生态环境主管部门会同自然资源等主管部门制定，按照规定向社会公开，并根据风险管控、修复情况适时更新。</p>
<p id="t59">&emsp;&emsp;<b>第五十九条</b>&emsp;对土壤污染状况普查、详查和监测、现场检查表明有土壤污染风险的建设用地地块，地方人民政府生态环境主管部门应当要求土地使用权人按照规定进行土壤污染状况调查。<br>
&emsp;&emsp;用途变更为住宅、公共管理与公共服务用地的，变更前应当按照规定进行土壤污染状况调查。<br>
&emsp;&emsp;前两款规定的土壤污染状况调查报告应当报地方人民政府生态环境主管部门，由地方人民政府生态环境主管部门会同自然资源主管部门组织评审。</p>
<p id="t60">&emsp;&emsp;<b>第六十条</b>&emsp;对土壤污染状况调查报告评审表明污染物含量超过土壤污染风险管控标准的建设用地地块，土壤污染责任人、土地使用权人应当按照国务院生态环境主管部门的规定进行土壤污染风险评估，并将土壤污染风险评估报告报省级人民政府生态环境主管部门。</p>
<p id="t61">&emsp;&emsp;<b>第六十一条</b>&emsp;省级人民政府生态环境主管部门应当会同自然资源等主管部门按照国务院生态环境主管部门的规定，对土壤污染风险评估报告组织评审，及时将需要实施风险管控、修复的地块纳入建设用地土壤污染风险管控和修复名录，并定期向国务院生态环境主管部门报告。<br>
&emsp;&emsp;列入建设用地土壤污染风险管控和修复名录的地块，不得作为住宅、公共管理与公共服务用地。</p>
<p id="t62">&emsp;&emsp;<b>第六十二条</b>&emsp;对建设用地土壤污染风险管控和修复名录中的地块，土壤污染责任人应当按照国家有关规定以及土壤污染风险评估报告的要求，采取相应的风险管控措施，并定期向地方人民政府生态环境主管部门报告。风险管控措施应当包括地下水污染防治的内容。</p>
<p id="t63">&emsp;&emsp;<b>第六十三条</b>&emsp;对建设用地土壤污染风险管控和修复名录中的地块，地方人民政府生态环境主管部门可以根据实际情况采取下列风险管控措施：<br>
&emsp;&emsp;（一）提出划定隔离区域的建议，报本级人民政府批准后实施；<br>
&emsp;&emsp;（二）进行土壤及地下水污染状况监测；<br>
&emsp;&emsp;（三）其他风险管控措施。</p>
<p id="t64">&emsp;&emsp;<b>第六十四条</b>&emsp;对建设用地土壤污染风险管控和修复名录中需要实施修复的地块，土壤污染责任人应当结合土地利用总体规划和城乡规划编制修复方案，报地方人民政府生态环境主管部门备案并实施。修复方案应当包括地下水污染防治的内容。</p>
<p id="t65">&emsp;&emsp;<b>第六十五条</b>&emsp;风险管控、修复活动完成后，土壤污染责任人应当另行委托有关单位对风险管控效果、修复效果进行评估，并将效果评估报告报地方人民政府生态环境主管部门备案。</p>
<p id="t66">&emsp;&emsp;<b>第六十六条</b>&emsp;对达到土壤污染风险评估报告确定的风险管控、修复目标的建设用地地块，土壤污染责任人、土地使用权人可以申请省级人民政府生态环境主管部门移出建设用地土壤污染风险管控和修复名录。<br>
&emsp;&emsp;省级人民政府生态环境主管部门应当会同自然资源等主管部门对风险管控效果评估报告、修复效果评估报告组织评审，及时将达到土壤污染风险评估报告确定的风险管控、修复目标且可以安全利用的地块移出建设用地土壤污染风险管控和修复名录，按照规定向社会公开，并定期向国务院生态环境主管部门报告。<br>
&emsp;&emsp;未达到土壤污染风险评估报告确定的风险管控、修复目标的建设用地地块，禁止开工建设任何与风险管控、修复无关的项目。</p>
<p id="t67">&emsp;&emsp;<b>第六十七条</b>&emsp;土壤污染重点监管单位生产经营用地的用途变更或者在其土地使用权收回、转让前，应当由土地使用权人按照规定进行土壤污染状况调查。土壤污染状况调查报告应当作为不动产登记资料送交地方人民政府不动产登记机构，并报地方人民政府生态环境主管部门备案。</p>
<p id="t68">&emsp;&emsp;<b>第六十八条</b>&emsp;土地使用权已经被地方人民政府收回，土壤污染责任人为原土地使用权人的，由地方人民政府组织实施土壤污染风险管控和修复。</p>
<h2 align="center" id="第五章-保障和监督" tabindex="-1"><a class="header-anchor" href="#第五章-保障和监督" aria-hidden="true">#</a> 第五章 保障和监督</h2>
...
<p id="t85">&emsp;&emsp;<b>第八十五条</b>&emsp;地方各级人民政府、生态环境主管部门或者其他负有土壤污染防治监督管理职责的部门未依照本法规定履行职责的，对直接负责的主管人员和其他直接责任人员依法给予处分。<br>
&emsp;&emsp;依照本法规定应当作出行政处罚决定而未作出的，上级主管部门可以直接作出行政处罚决定。</p>
<p id="t86">&emsp;&emsp;<b>第八十六条</b>&emsp;违反本法规定，有下列行为之一的，由地方人民政府生态环境主管部门或者其他负有土壤污染防治监督管理职责的部门责令改正，处以罚款；拒不改正的，责令停产整治：<br>
&emsp;&emsp;（一）土壤污染重点监管单位未制定、实施自行监测方案，或者未将监测数据报生态环境主管部门的；<br>
&emsp;&emsp;（二）土壤污染重点监管单位篡改、伪造监测数据的；<br>
&emsp;&emsp;（三）土壤污染重点监管单位未按年度报告有毒有害物质排放情况，或者未建立土壤污染隐患排查制度的；<br>
&emsp;&emsp;（四）拆除设施、设备或者建筑物、构筑物，企业事业单位未采取相应的土壤污染防治措施或者土壤污染重点监管单位未制定、实施土壤污染防治工作方案的；<br>
&emsp;&emsp;（五）尾矿库运营、管理单位未按照规定采取措施防止土壤污染的；<br>
&emsp;&emsp;（六）尾矿库运营、管理单位未按照规定进行土壤污染状况监测的；<br>
&emsp;&emsp;（七）建设和运行污水集中处理设施、固体废物处置设施，未依照法律法规和相关标准的要求采取措施防止土壤污染的。<br>
&emsp;&emsp;有前款规定行为之一的，处二万元以上二十万元以下的罚款；有前款第二项、第四项、第五项、第七项规定行为之一，造成严重后果的，处二十万元以上二百万元以下的罚款。</p>
<p id="t87">&emsp;&emsp;<b>第八十七条</b>&emsp;违反本法规定，向农用地排放重金属或者其他有毒有害物质含量超标的污水、污泥，以及可能造成土壤污染的清淤底泥、尾矿、矿渣等的，由地方人民政府生态环境主管部门责令改正，处十万元以上五十万元以下的罚款；情节严重的，处五十万元以上二百万元以下的罚款，并可以将案件移送公安机关，对直接负责的主管人员和其他直接责任人员处五日以上十五日以下的拘留；有违法所得的，没收违法所得。</p>
<p id="t88">&emsp;&emsp;<b>第八十八条</b>&emsp;违反本法规定，农业投入品生产者、销售者、使用者未按照规定及时回收肥料等农业投入品的包装废弃物或者农用薄膜，或者未按照规定及时回收农药包装废弃物交由专门的机构或者组织进行无害化处理的，由地方人民政府农业农村主管部门责令改正，处一万元以上十万元以下的罚款；农业投入品使用者为个人的，可以处二百元以上二千元以下的罚款。</p>
<p id="t89">&emsp;&emsp;<b>第八十九条</b>&emsp;违反本法规定，将重金属或者其他有毒有害物质含量超标的工业固体废物、生活垃圾或者污染土壤用于土地复垦的，由地方人民政府生态环境主管部门责令改正，处十万元以上一百万元以下的罚款；有违法所得的，没收违法所得。</p>
<p id="t90">&emsp;&emsp;<b>第九十条</b>&emsp;违反本法规定，受委托从事土壤污染状况调查和土壤污染风险评估、风险管控效果评估、修复效果评估活动的单位，出具虚假调查报告、风险评估报告、风险管控效果评估报告、修复效果评估报告的，由地方人民政府生态环境主管部门处十万元以上五十万元以下的罚款；情节严重的，禁止从事上述业务，并处五十万元以上一百万元以下的罚款；有违法所得的，没收违法所得。<br>
&emsp;&emsp;前款规定的单位出具虚假报告的，由地方人民政府生态环境主管部门对直接负责的主管人员和其他直接责任人员处一万元以上五万元以下的罚款；情节严重的，十年内禁止从事前款规定的业务；构成犯罪的，终身禁止从事前款规定的业务。<br>
&emsp;&emsp;本条第一款规定的单位和委托人恶意串通，出具虚假报告，造成他人人身或者财产损害的，还应当与委托人承担连带责任。</p>
<p id="t91">&emsp;&emsp;<b>第九十一条</b>&emsp;违反本法规定，有下列行为之一的，由地方人民政府生态环境主管部门责令改正，处十万元以上五十万元以下的罚款；情节严重的，处五十万元以上一百万元以下的罚款；有违法所得的，没收违法所得；对直接负责的主管人员和其他直接责任人员处五千元以上二万元以下的罚款：<br>
&emsp;&emsp;（一）未单独收集、存放开发建设过程中剥离的表土的；<br>
&emsp;&emsp;（二）实施风险管控、修复活动对土壤、周边环境造成新的污染的；<br>
&emsp;&emsp;（三）转运污染土壤，未将运输时间、方式、线路和污染土壤数量、去向、最终处置措施等提前报所在地和接收地生态环境主管部门的；<br>
&emsp;&emsp;（四）未达到土壤污染风险评估报告确定的风险管控、修复目标的建设用地地块，开工建设与风险管控、修复无关的项目的。</p>
<p id="t92">&emsp;&emsp;<b>第九十二条</b>&emsp;违反本法规定，土壤污染责任人或者土地使用权人未按照规定实施后期管理的，由地方人民政府生态环境主管部门或者其他负有土壤污染防治监督管理职责的部门责令改正，处一万元以上五万元以下的罚款；情节严重的，处五万元以上五十万元以下的罚款。</p>
<p id="t93">&emsp;&emsp;<b>第九十三条</b>&emsp;违反本法规定，被检查者拒不配合检查，或者在接受检查时弄虚作假的，由地方人民政府生态环境主管部门或者其他负有土壤污染防治监督管理职责的部门责令改正，处二万元以上二十万元以下的罚款；对直接负责的主管人员和其他直接责任人员处五千元以上二万元以下的罚款。</p>
<p id="t94">&emsp;&emsp;<b>第九十四条</b>&emsp;违反本法规定，土壤污染责任人或者土地使用权人有下列行为之一的，由地方人民政府生态环境主管部门或者其他负有土壤污染防治监督管理职责的部门责令改正，处二万元以上二十万元以下的罚款；拒不改正的，处二十万元以上一百万元以下的罚款，并委托他人代为履行，所需费用由土壤污染责任人或者土地使用权人承担；对直接负责的主管人员和其他直接责任人员处五千元以上二万元以下的罚款：<br>
&emsp;&emsp;（一）未按照规定进行土壤污染状况调查的；<br>
&emsp;&emsp;（二）未按照规定进行土壤污染风险评估的；<br>
&emsp;&emsp;（三）未按照规定采取风险管控措施的；<br>
&emsp;&emsp;（四）未按照规定实施修复的；<br>
&emsp;&emsp;（五）风险管控、修复活动完成后，未另行委托有关单位对风险管控效果、修复效果进行评估的。<br>
...
<p><a href="https://flk.npc.gov.cn/detail2.html?MmM5MDlmZGQ2NzhiZjE3OTAxNjc4YmY4YmIxMTBiOGI%3D" target="_blank" rel="noopener noreferrer">https://flk.npc.gov.cn/detail2.html?MmM5MDlmZGQ2NzhiZjE3OTAxNjc4YmY4YmIxMTBiOGI%3D<ExternalLinkIcon/></a></p>
</div>
</div></template>
