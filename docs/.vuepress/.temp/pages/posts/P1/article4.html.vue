<template><div><h2 align="center" id="中华人民共和国行政强制法" tabindex="-1"><a class="header-anchor" href="#中华人民共和国行政强制法" aria-hidden="true">#</a> 中华人民共和国行政强制法</h2>
<div class="custom-container tip"><p class="custom-container-title">（2011年6月30日第十一届全国人民代表大会常务委员会第二十一次会议通过）</p>
</div>
<details class="custom-container details"><summary>目录</summary>
<Tabs :data='[{"title":"章节"},{"title":"条例"}]'>
<template #tab0="{ title, value, isActive }">
<nav class="table-of-contents"><ul><li><router-link to="#中华人民共和国行政强制法">中华人民共和国行政强制法</router-link></li><li><router-link to="#第一章-总则">第一章 总则</router-link></li><li><router-link to="#第二章-行政强制的种类和设定">第二章 行政强制的种类和设定</router-link></li><li><router-link to="#第三章-行政强制措施实施程序">第三章 行政强制措施实施程序</router-link><ul><li><router-link to="#第一节-一般规定">第一节 一般规定</router-link></li><li><router-link to="#第二节-查封、扣押">第二节 查封、扣押</router-link></li><li><router-link to="#第三节-冻结">第三节 冻结</router-link></li></ul></li><li><router-link to="#第四章-行政机关强制执行程序">第四章 行政机关强制执行程序</router-link><ul><li><router-link to="#第一节-一般规定-1">第一节 一般规定</router-link></li><li><router-link to="#第二节-金钱给付-义务的执行">第二节 金钱给付#义务的执行</router-link></li><li><router-link to="#第三节-代履行">第三节 代履行</router-link></li></ul></li><li><router-link to="#第五章-申请人民法院强制执行">第五章 申请人民法院强制执行</router-link></li><li><router-link to="#第六章-法律责任">第六章 法律责任</router-link></li><li><router-link to="#第七章-附则">第七章 附则</router-link></li></ul></nav>
</template>
...
<li>
<p>第61条~71条</p>
<p><a href="#t61">61</a> <a href="#t62">62</a> <a href="#t63">63</a> <a href="#t64">64</a> <a href="#t65">65</a> <a href="#t66">66</a> <a href="#t67">67</a> <a href="#t68">68</a> <a href="#t69">69</a> <a href="#t70">70</a> <a href="#t71">71</a></p>
</li>
</ul>
</template>
</Tabs>
...
<h2 align="center" id="第二章-行政强制的种类和设定" tabindex="-1"><a class="header-anchor" href="#第二章-行政强制的种类和设定" aria-hidden="true">#</a> 第二章 行政强制的种类和设定</h2>
...
<h2 align="center" id="第三章-行政强制措施实施程序" tabindex="-1"><a class="header-anchor" href="#第三章-行政强制措施实施程序" aria-hidden="true">#</a> 第三章 行政强制措施实施程序</h2>
...
<h3 align="center" id="第二节-查封、扣押" tabindex="-1"><a class="header-anchor" href="#第二节-查封、扣押" aria-hidden="true">#</a> 第二节 查封、扣押</h3>
...
<h3 align="center" id="第三节-冻结" tabindex="-1"><a class="header-anchor" href="#第三节-冻结" aria-hidden="true">#</a> 第三节 冻结</h3>
...
<h2 align="center" id="第四章-行政机关强制执行程序" tabindex="-1"><a class="header-anchor" href="#第四章-行政机关强制执行程序" aria-hidden="true">#</a> 第四章 行政机关强制执行程序</h2>
<h3 align="center" id="第一节-一般规定-1" tabindex="-1"><a class="header-anchor" href="#第一节-一般规定-1" aria-hidden="true">#</a> 第一节 一般规定</h3>
...
<h3 align="center" id="第二节-金钱给付-义务的执行" tabindex="-1"><a class="header-anchor" href="#第二节-金钱给付-义务的执行" aria-hidden="true">#</a> 第二节 金钱给付#义务的执行</h3>
...
<h3 align="center" id="第三节-代履行" tabindex="-1"><a class="header-anchor" href="#第三节-代履行" aria-hidden="true">#</a> 第三节 代履行</h3>
<p id="t50">&emsp;&emsp;<b>第五十条</b>&emsp;行政机关依法作出要求当事人履行排除妨碍、恢复原状等义务的行政决定，当事人逾期不履行，经催告仍不履行，其后果已经或者将危害交通安全、造成环境污染或者破坏自然资源的，行政机关可以代履行，或者委托没有利害关系的第三人代履行。</p>
<p id="t51">&emsp;&emsp;<b>第五十一条</b>&emsp;代履行应当遵守下列规定：<br>
&emsp;&emsp;（一）代履行前送达决定书，代履行决定书应当载明当事人的姓名或者名称、地址，代履行的理由和依据、方式和时间、标的、费用预算以及代履行人；<br>
&emsp;&emsp;（二）代履行三日前，催告当事人履行，当事人履行的，停止代履行；<br>
&emsp;&emsp;（三）代履行时，作出决定的行政机关应当派员到场监督；<br>
&emsp;&emsp;（四）代履行完毕，行政机关到场监督的工作人员、代履行人和当事人或者见证人应当在执行文书上签名或者盖章。<br>
&emsp;&emsp;代履行的费用按照成本合理确定，由当事人承担。但是，法律另有规定的除外。<br>
&emsp;&emsp;代履行不得采用暴力、胁迫以及其他非法方式。</p>
<p id="t52">&emsp;&emsp;<b>第五十二条</b>&emsp;需要立即清除道路、河道、航道或者公共场所的遗洒物、障碍物或者污染物，当事人不能清除的，行政机关可以决定立即实施代履行；当事人不在场的，行政机关应当在事后立即通知当事人，并依法作出处理。</p>
<h2 align="center" id="第五章-申请人民法院强制执行" tabindex="-1"><a class="header-anchor" href="#第五章-申请人民法院强制执行" aria-hidden="true">#</a> 第五章 申请人民法院强制执行</h2>
<p id="t53">&emsp;&emsp;<b>第五十三条</b>&emsp;当事人在法定期限内不申请行政复议或者提起行政诉讼，又不履行行政决定的，没有行政强制执行权的行政机关可以自期限届满之日起三个月内，依照本章规定申请人民法院强制执行。</p>
<p id="t54">&emsp;&emsp;<b>第五十四条</b>&emsp;行政机关申请人民法院强制执行前，应当催告当事人履行义务。催告书送达十日后当事人仍未履行义务的，行政机关可以向所在地有管辖权的人民法院申请强制执行；执行对象是不动产的，向不动产所在地有管辖权的人民法院申请强制执行。</p>
<p id="t55">&emsp;&emsp;<b>第五十五条</b>&emsp;行政机关向人民法院申请强制执行，应当提供下列材料：<br>
&emsp;&emsp;（一）强制执行申请书；<br>
&emsp;&emsp;（二）行政决定书及作出决定的事实、理由和依据；<br>
&emsp;&emsp;（三）当事人的意见及行政机关催告情况；<br>
&emsp;&emsp;（四）申请强制执行标的情况；<br>
&emsp;&emsp;（五）法律、行政法规规定的其他材料。<br>
&emsp;&emsp;强制执行申请书应当由行政机关负责人签名，加盖行政机关的印章，并注明日期。</p>
<p id="t56">&emsp;&emsp;<b>第五十六条</b>&emsp;人民法院接到行政机关强制执行的申请，应当在五日内受理。<br>
&emsp;&emsp;行政机关对人民法院不予受理的裁定有异议的，可以在十五日内向上一级人民法院申请复议，上一级人民法院应当自收到复议申请之日起十五日内作出是否受理的裁定。</p>
<p id="t57">&emsp;&emsp;<b>第五十七条</b>&emsp;人民法院对行政机关强制执行的申请进行书面审查，对符合本法第五十五条规定，且行政决定具备法定执行效力的，除本法第五十八条规定的情形外，人民法院应当自受理之日起七日内作出执行裁定。</p>
<p id="t58">&emsp;&emsp;<b>第五十八条</b>&emsp;人民法院发现有下列情形之一的，在作出裁定前可以听取被执行人和行政机关的意见：<br>
&emsp;&emsp;（一）明显缺乏事实根据的；<br>
&emsp;&emsp;（二）明显缺乏法律、法规依据的；<br>
&emsp;&emsp;（三）其他明显违法并损害被执行人合法权益的。<br>
&emsp;&emsp;人民法院应当自受理之日起三十日内作出是否执行的裁定。裁定不予执行的，应当说明理由，并在五日内将不予执行的裁定送达行政机关。<br>
&emsp;&emsp;行政机关对人民法院不予执行的裁定有异议的，可以自收到裁定之日起十五日内向上一级人民法院申请复议，上一级人民法院应当自收到复议申请之日起三十日内作出是否执行的裁定。</p>
<p id="t59">&emsp;&emsp;<b>第五十九条</b>&emsp;因情况紧急，为保障公共安全，行政机关可以申请人民法院立即执行。经人民法院院长批准，人民法院应当自作出执行裁定之日起五日内执行。</p>
...
<p><a href="https://flk.npc.gov.cn/detail2.html?MmM5MDlmZGQ2NzhiZjE3OTAxNjc4YmY3MmY3YTA2MTM%3D" target="_blank" rel="noopener noreferrer">https://flk.npc.gov.cn/detail2.html?MmM5MDlmZGQ2NzhiZjE3OTAxNjc4YmY3MmY3YTA2MTM%3D<ExternalLinkIcon/></a></p>
</div>
</div></template>
